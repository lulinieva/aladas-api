...
public class Vuelo {
    ...
    public enum EstadoVueloEnum {
        GENERADO(1), ORIGEN_ASIGNADO(2), DESTINO_ASIGNADO(3), TRIPULASION_PREASIGNADA(4), ABIERTO(5), CONFIRMADO(6),
        REPROGRAMADO(7), CANCELADO(8), CERRADO(9); // NO AGREGAMOS MAS ESTADOS PORQUE ESTE SIESTEMA ESTA ENFOCADO AL
                                                   // AL SISTEMA DE RESERVA
